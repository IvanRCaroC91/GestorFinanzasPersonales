            ...
            <Table>
              ...
              <TableBody>
                {presupuestos.map((presupuesto) => {
                  ...
                  const porcentajeUtilizado = ejecucion ? ejecucion.porcentajeUtilizado : 0;
                  ...
                  return (
                    <TableRow key={presupuesto.id}>
                      ...
                      <TableCell align="right">
                        <Typography color={porcentajeUtilizado > 100 ? 'error.main' : 'text.primary'}>
                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          <LinearProgress
                            variant="determinate"
                            value={Math.min(porcentajeUtilizado, 100)}
                            sx={{ 
                              flex: 1,
                              height: 8,
                              borderRadius: 4,
                              ...
                              '& .MuiLinearProgress-bar': {
                                backgroundColor: porcentajeUtilizado >= 90 ? '#f44336' : 
                                               porcentajeUtilizado >= 75 ? '#ff9800' : '#4caf50'
                              }
                            }}
                          />
